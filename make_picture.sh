...
sed -i 's#<g transform="translate(0,0)" id="fullSVG">#<g transform="translate(35,5)" id="fullSVG">#g' "${output_dir}/${name}.svg"
sed -i 's#<g transform="translate(0,0)" id="alignmentSVG">#<g transform="translate(0,100)" id="alignmentSVG">#g' "${output_dir}/${name}.svg"
